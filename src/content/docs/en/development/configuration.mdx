---
title: Configuration
description: Complete guide to configuration management in Better SaaS, including environment variables, feature flags, and settings
---
...
- Review [Database Schema](./database-schema) for data configuration
- Explore [API Routes](./api-routes) for API configuration
- Check [Components](./components) for component configuration
- Learn about [State Management](./state-management) for runtime configuration 