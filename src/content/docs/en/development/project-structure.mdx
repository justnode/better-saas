...
description: Complete guide to Better SaaS project structure, directory organization, and file conventions
---
...
- Review [Configuration](./configuration) for detailed setup
- Explore [Database Schema](./database-schema) for data modeling
- Check [API Routes](./api-routes) for backend development
- Learn about [Components](./components) for UI development 