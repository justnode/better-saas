---
title: Quick Start
description: Get your Better SaaS project up and running in 5 minutes
---
...
- Read the [Architecture Guide](/docs/architecture) to understand the system design
- Check out the [Features Documentation](/docs/features) for detailed feature explanations

### 2. **Customize Your Application**
- Follow the [Customization Guide](/docs/customization) to make it your own
...
- Follow the [Deployment Guide](/docs/deployment) for production setup
- Configure production environment variables
- Set up monitoring and analytics

### 5. **Learn the Codebase**
- Read the [Development Guide](/docs/development) for coding guidelines
- Explore the [API Documentation](/docs/api) for backend integration
- Check out the [Testing Guide](/docs/testing) for testing strategies
...
**Need help?** Check out our comprehensive documentation or reach out to the community for support.

---

**Ready for the next step?** Learn about the [system architecture](/docs/architecture) to understand how everything works together.